...
-- 1. Tạo VIEW hiển thị người dùng có họ "Nguyễn"
...
-- 2. Hiển thị dữ liệu từ VIEW vừa tạo
SELECT * FROM view_users_firstname;


-- 3. Thêm một nhân viên mới có họ "Nguyễn"
INSERT INTO users (username, full_name, gender, email, password)
VALUES ('nguyenvana', 'Nguyễn Văn A', 'Nam', 'nguyenvana@gmail.com', '123');


-- 4. Truy vấn lại VIEW để kiểm tra nhân viên vừa thêm
SELECT * FROM view_users_firstname;
...
-- 6. Truy vấn lại VIEW để kiểm tra nhân viên đã bị xóa
SELECT * FROM view_users_firstname;
