...
UPDATE orders SET total_amount = 20300000 WHERE order_id = 103;
UPDATE orders SET total_amount = 10200000 WHERE order_id = 104;
UPDATE orders SET total_amount = 10800000 WHERE order_id = 105;
